...
public class Program2 extends ProgramSecondary {
    ...
    private void createNewRep() {
        ...
        /*
         * Create new rep with unnamed program name and empty representations of
         * the body and context.
         */
    ...
    public final void setName(String n) {
        ...
        // Set this's name to passed in argument.
        this.name = n;
    }
    ...
    public final String name() {
        ...
        // Return this's class member variable name.
        return this.name;
    }
    ...
    public final Map<String, Statement> newContext() {
        ...
        // Return same dynamic type map as this.context.
    ...
    public final void swapContext(Map<String, Statement> c) {
        ...
        // Do simple swap of variables like with integer swapping.
    ...
    public final void swapBody(Statement b) {
        ...
        // Do simple swap of variables like integer swapping.
