...
/**
 * First-in-first-out (FIFO) waitingline kernel component with primary methods. (Note:
 ...
 */
public interface WaitingLineKernel<T> extends Standard<T>, Iterable<T> {

        /**
         * Adds {@code x} to the end of {@code this} if not already contained in this.
         *
         * @param x
         ...
         * @updates this
         * @requires this /= <>
         * @ensures #this = <removeFromLine> * this
         */
        T removeFromLine();
