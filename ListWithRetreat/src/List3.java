...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        // Initialize preStart node.
        this.preStart = new Node();

        // Point lastLeft to the beginning of the list.
        this.lastLeft = this.preStart;
        this.postFinish = new Node();

        // Point preStart and PostFinish to one another.
    ...
    public final void addRightFront(T x) {
        ...
        /*
         * Point node to lastLeft and lastLeft.next before changing other
         * references.
         */
        node.next = this.lastLeft.next;
        node.previous = this.lastLeft;

        // Point other references to the new node.
