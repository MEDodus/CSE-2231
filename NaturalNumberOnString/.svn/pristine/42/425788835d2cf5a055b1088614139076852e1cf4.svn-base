...
public abstract class NaturalNumberTest {
    ...
    /**
     * Testing when one (n) NaturalNumber rep is zero and the other (nExpected)
     * is.
     */
    @Test
    public final void testIsZeroOpposites1() {
        final int val = 1235;
        NaturalNumber n = this.constructorTest();
        NaturalNumber nExpected = this.constructorRef(val);
        assertEquals(nExpected.isZero(), !n.isZero());
    ...
    /**
     * Testing when one (n) NaturalNumber rep is not zero and the other
     * (nExpected) is.
     */
    @Test
    public final void testIsZeroOpposites2() {
        final int val = 1235;
        NaturalNumber n = this.constructorTest(val);
        NaturalNumber nExpected = this.constructorRef();
        assertEquals(nExpected.isZero(), !n.isZero());
